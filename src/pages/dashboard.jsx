...
function Dashboard() {
  ...
  return (
    <div className="flex-1 overflow-y-auto relative bg-[#F8FAFC] font-sans select-none overflow-x-hidden pb-20 md:pb-10 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      ...
      >
        ...
        <motion.header variants={itemVariants} className="mb-6 md:mb-10 px-2">
          <h1 className="text-3xl md:text-4xl font-bold text-slate-800 tracking-tighter">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-4 md:gap-6">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between">
              <div>
                <h2 className="text-2xl md:text-4xl font-bold leading-tight tracking-tight max-w-md">
              ...
              <div className="mt-8 md:mt-12">
                <div className="inline-flex items-center gap-3 bg-white text-emerald-700 px-6 py-4 rounded-2xl font-bold text-xs uppercase tracking-widest shadow-xl group-hover:shadow-white/20 transition-all group-active:scale-95">
          ...
          >
            ...
            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Total Arsip Server</p>
            <h3 className="text-4xl md:text-5xl font-bold text-slate-800 tracking-tighter">
          ...
          >
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1 leading-tight">Upload<br/>Bulan Ini</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-1 leading-tight">Pengguna<br/>Aktif</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-3">
              {loading ? (
                <div className="py-10 text-center text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em] animate-pulse">
                  Menarik Data Server...
                </div>
              ) : dashboardData.recentActivities.length === 0 ? (
                <div className="py-10 text-center text-slate-400 text-[10px] font-bold uppercase tracking-[0.3em]">
                  Belum ada aktivitas
                </div>
              ) : (
                  ...
                  >
                    <div className="flex items-center gap-4 overflow-hidden">
                      ...
                      <div className="min-w-0">
                        ...
                        <span className="inline-block px-2.5 py-1 mt-1 bg-slate-100 group-hover:bg-emerald-100 text-slate-500 group-hover:text-emerald-700 rounded-md text-[8px] md:text-[9px] font-bold uppercase tracking-widest transition-colors">
                          {row.cat}
                        </span>
                      </div>
                    </div>
